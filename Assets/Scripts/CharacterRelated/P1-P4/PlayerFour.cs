...
// public class PlayerFour : Player
// {

//         //CharacterInstrument
//     [SerializeField] private string instrument4; 

//      //Defense stats
//     [SerializeField] private int helmetD4;
//     [SerializeField] private int shieldD4;
//     [SerializeField] private int bootsD4;
...
//     void Start()
//     {
//         mana4.Initialize(initMana, initMana);
//         exp4.Initialize(0, Mathf.Floor(100*MyLevel*Mathf.Pow(MyLevel, 0.5f)));
//         levelText4.text = MyLevel.ToString();
//         base.Start();
//     }
...
//           if (Input.GetKey(KeybindManager.MyInstance.Player4binds["UP4"])) //Moves up
//           {
//              exitIndex = 0;
//              Direction += Vector2.up;
             
//           }
//           if (Input.GetKey(KeybindManager.MyInstance.Player4binds["LEFT4"])) //Moves left
//           {
              
//               exitIndex = 3;
//               Direction += Vector2.left; 
//           }
//           if (Input.GetKey(KeybindManager.MyInstance.Player4binds["DOWN4"]))
//           {
//               exitIndex = 2;
//               Direction += Vector2.down;
//           }
//           if (Input.GetKey(KeybindManager.MyInstance.Player4binds["RIGHT4"])) //Moves right
//           {
//               exitIndex = 1;
...
//     public void P4(int xp)
//     {
//     exp4.MyCurrentValue += xp;

//     if (exp4.MyCurrentValue >= exp4.MyMaxValue)
//     {
//         StartCoroutine(Ding());
...
//         MyLevel++;
//         levelText4.text = MyLevel.ToString();
//         exp4.MyMaxValue = 100 * MyLevel*Mathf.Pow(MyLevel, 0.5f);
//         exp4.MyMaxValue = Mathf.Floor(exp4.MyMaxValue);
//         exp4.MyCurrentValue = exp4.MyOverflow;
//         exp4.Reset();
